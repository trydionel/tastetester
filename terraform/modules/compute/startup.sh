...
/opt/tastetester-venv/bin/prefect deploy /opt/tastetester/etl/main.py:main --name "tastetester-etl" --pool "tastetester-work-pool" --work-queue "tastetester-work-queue" || true
